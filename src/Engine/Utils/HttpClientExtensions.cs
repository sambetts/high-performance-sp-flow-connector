...
namespace Engine.Utils
{
    ...
    {
        public static async Task<HttpResponseMessage> GetAsyncWithThrottleRetries(this SecureSPThrottledHttpClient httpClient, string url, ILogger debugTracer)
        {
        ...
        public static async Task<HttpResponseMessage> GetAsyncWithThrottleRetries(this SecureSPThrottledHttpClient httpClient, string url, HttpCompletionOption completionOption, ILogger debugTracer)
        {
        ...
        public static async Task<HttpResponseMessage> PostAsyncWithThrottleRetries(this SecureSPThrottledHttpClient httpClient, string url, object body, ILogger debugTracer)
        {
            if (httpClient is null)
            {
                throw new ArgumentNullException(nameof(httpClient));
        ...
        public static async Task<HttpResponseMessage> PostAsyncWithThrottleRetries(this SecureSPThrottledHttpClient httpClient, string url, string bodyContent, string mimeType, string boundary, ILogger debugTracer)
        {
            if (httpClient is null)
            {
                throw new ArgumentNullException(nameof(httpClient));
